...
const scenarios: Scenario[] = [
  ...
  },
  {
    ...
    chains: [
      { id: "base", name: "Base", role: "买家付款链", color: "#0052FF", Logo: BaseLogo },
      { id: "zeta", name: "ZetaChain", role: "编排层", color: "#00D395", Logo: ZetaChainLogo },
      { id: "polygon", name: "Polygon", role: "收据链", color: "#8247E5", Logo: PolygonLogo },
    ],
    steps: [
      { id: 1, from: "base", to: "zeta", label: "depositAndCall()", desc: "USDC + 订单信息", color: "#0052FF" },
      { id: 2, from: "zeta", to: "zeta", label: "验证订单", desc: "校验商品 & 库存", color: "#00D395" },
      { id: 3, from: "zeta", to: "base", label: "gateway.withdraw()", desc: "货款 → 商家", color: "#00D395" },
      { id: 4, from: "zeta", to: "polygon", label: "mint 收据 NFT", desc: "订单凭证上链", color: "#00D395" },
      { id: 5, from: "polygon", to: "polygon", label: "商家发货", desc: "链下物流履约", color: "#8247E5" },
    ],
    results: [
      { chain: "base", text: "商家收到货款" },
      { chain: "zeta", text: "订单记录上链" },
  ...
  },
  {
    id: "cross-swap",
    title: "跨链换币",
    subtitle: "ZetaChain Universal Swap",
    badge: "Planned",
    badgeColor: "#9945FF",
    chains: [
      ...
      { id: "eth", name: "Ethereum", role: "目标 ETH", color: "#627EEA", Logo: EthereumLogo },
    ],
    steps: [
      { id: 1, from: "base", to: "zeta", label: "depositAndCall()", desc: "Base USDC", color: "#0052FF" },
      { id: 2, from: "zeta", to: "zeta", label: "Swap USDC → ETH", desc: "ZetaChain DEX", color: "#00D395" },
      { id: 3, from: "zeta", to: "eth", label: "gateway.withdraw()", desc: "ETH → 目标地址", color: "#00D395" },
      { id: 4, from: "eth", to: "eth", label: "ETH 到账", desc: "以太坊主网", color: "#627EEA" },
    ],
    results: [
      { chain: "base", text: "USDC 已扣除" },
      { chain: "zeta", text: "Swap 完成" },
      { chain: "eth", text: "收到 ETH" },
    ],
  },
];
