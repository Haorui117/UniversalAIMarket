    ...
    products: [
      {
        ...
        kind: "digital",
        description:
          "传奇武器 NFT，托管在 Polygon。只有跨链付款完成后才会自动释放给买家。",
        priceUSDC: "80",
        tokenId: 1,
        demoReady: true,
        inventory: "limited",
      ...
      },
      {
        ...
        kind: "digital",
        description:
          "高精度能量长枪，所有权可证明。适合 PvP Demo 和链上成就展示。",
        priceUSDC: "120",
        tokenId: 2,
        demoReady: false,
        inventory: "preorder",
      ...
      },
      {
        ...
        kind: "digital",
        description:
          "防御型装备 NFT，适合展示「先托管、后结算、再交付」的跨链电商逻辑。",
        priceUSDC: "45",
        tokenId: 3,
        demoReady: false,
        inventory: "in_stock",
  ...
  },
  {
    ...
    products: [
      ...
      },
      {
        ...
        kind: "physical",
        description:
          "每月订阅收据 NFT。后续可以基于持有收据做权益门槛，并支持在任意链付款。",
        priceUSDC: "15",
        tokenId: 8,
        demoReady: false,
        inventory: "preorder",
      ...
      },
      {
        ...
        kind: "physical",
        description:
          "联名周边链下发货，链上收据作为保修/兑换凭证，也可用于后续空投与会员权益。",
        priceUSDC: "12",
        tokenId: 9,
        demoReady: false,
        inventory: "limited",
